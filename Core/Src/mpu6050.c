...
void MPU6050_Read_All(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    DataStruct->Accel_X_RAW = (int16_t)(Rec_Data[0] << 8 | Rec_Data[1])- (int16_t)(DataStruct->Accel_X_RAW_0);
    DataStruct->Accel_Y_RAW = (int16_t)(Rec_Data[2] << 8 | Rec_Data[3])- (int16_t)(DataStruct->Accel_Y_RAW_0);
    DataStruct->Accel_Z_RAW = (int16_t)(Rec_Data[4] << 8 | Rec_Data[5])- (int16_t)(DataStruct->Accel_Z_RAW_0);
    temp = (int16_t)(Rec_Data[6] << 8 | Rec_Data[7]);
    DataStruct->Gyro_X_RAW = (int16_t)(Rec_Data[8] << 8 | Rec_Data[9])- (int16_t)(DataStruct->Gyro_X_RAW_0);
    DataStruct->Gyro_Y_RAW = (int16_t)(Rec_Data[10] << 8 | Rec_Data[11])- (int16_t)(DataStruct->Gyro_Y_RAW_0);
    DataStruct->Gyro_Z_RAW = (int16_t)(Rec_Data[12] << 8 | Rec_Data[13])- (int16_t)(DataStruct->Gyro_Z_RAW_0);
...
void Calib (MPU6050_t *DataStruct){
	uint8_t Rec_Data[14];
	uint16_t temp;
	...
	DataStruct->Accel_Z_RAW_0 = SumACC_Z/100- 16384.0;
